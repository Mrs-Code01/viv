...
const NavBar = () => {
  ...
  return (
    <nav>
      ...
      <ul
        className={`navLinksContainer ${hamburgerClick ? "showNav" : ""}`}
        ...
        <li>
          ...
          {isDropdownBlog && (
            <ul className="newsandblog-dropdown">
              <li>
                <Link to="./NewsAndBlog/OurBlog">Our Blog</Link>
              </li>
              <li>
                <Link to="./NewsAndBlog/NewsArchive">News Archive</Link>
              </li>
            </ul>
          )}
        </li>
